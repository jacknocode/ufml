...
function CustomNodePresentationBase({ data }: CustomNodeProps) {
...
function EllipseNodePresentationBase({ data }: CustomNodeProps) {
  return (
    <div
...
export const CustomNodePresentation = memo(CustomNodePresentationBase)
CustomNodePresentation.displayName = 'CustomNodePresentation'

export const EllipseNodePresentation = memo(EllipseNodePresentationBase)
EllipseNodePresentation.displayName = 'EllipseNodePresentation'

// Define nodeTypes outside of any component
export const nodeTypes = {
  screenNode: CustomNodePresentation,
  ellipseNode: EllipseNodePresentation,
}
